...
public class StringToolBoxTester02 {

	public static void main(String[] args) {

		//System.out.println("***Testing: boolean endsWithStar(String s)***");
		//System.out.println("true = " + StringToolBox.caesar("abcd", 5));
		//System.out.println("false = " + StringToolBox.caesar(""));
		...
		System.out.println("The hippo is native to Western Africa." + StringToolBox.caesar("The hippo is native to Western Africa.",5));
